...
Diagram \textit{activity} untuk skenario pencatatan pembayaran ini akan menjelaskan bagaimana \textit{request} terhadap proses pencatatan pembayaran dilakukan oleh \textit{server web services}. Diagram \textit{activity} ini seperti terlihat pada gambar \ref{fig:uml-act-bayar} :
